...
| DBG_TOOLBAR              | A boolean that enables/disables [Django Debug Toolbar](https://pypi.org/project/django-debug-toolbar/); set to any of 'true', 'on', 'ok', 'y', 'yes', '1' to enable. Only valid when debug mode is enabled.                                                                                                                                                                                                                                                                             |
