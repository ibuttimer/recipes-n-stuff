...
| [jsonpickle](https://pypi.org/project/json-fix/)                                                     | Serialisation of non-standard objects                                                                            | Python library for serializing any arbitrary object graph into JSON. It is a library for the two-way conversion of complex Python objects and JSON.                                                                                       |
