...
| [argon2-cffi](https://pypi.org/project/argon2-cffi/)                                                 | Generate password hashes                                                                                         | A library implements Argon2 version 1.3, as described in [Argon2: the memory-hard function for password hashing and other applications](https://www.cryptolux.org/images/0/0d/Argon2.pdf).                                                |
| [isoduration](https://pypi.org/project/isoduration/)                                                 | Decode ISO 8601 durations                                                                                        | A library providing handling of ISO 8601 durations in textual format.                                                                                                                                                                     |
